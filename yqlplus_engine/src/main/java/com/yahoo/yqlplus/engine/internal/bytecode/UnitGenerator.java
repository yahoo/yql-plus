...
public class UnitGenerator {
    ...
    protected UnitGenerator(String name, ASMClassSource environment) {
        this(name, environment.getType(Object.class).getInternalName(), environment);
    }

    protected UnitGenerator(String name, Class<?> superClazz, ASMClassSource environment) {
    ...
    protected UnitGenerator(String name, String superClassName, ASMClassSource environment) {
        this.name = name;
    ...
    protected ConstructorGenerator createConstructor() {
