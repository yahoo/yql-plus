...
public interface GambitCreator extends GambitTypes {
    ...
    BytecodeExpression scatter(Location location, BytecodeExpression runtime, BytecodeExpression iterable, CallableInvocable function);

    BytecodeExpression fork(Location location, BytecodeExpression runtime, CallableInvocable function, BytecodeExpression... arguments);

    BytecodeExpression fork(Location location, BytecodeExpression runtime, CallableInvocable function, List<BytecodeExpression> arguments);
