...
import com.yahoo.yqlplus.compiler.code.PopSequence;
...
import com.yahoo.yqlplus.compiler.types.ArrayTypeWidget;
import com.yahoo.yqlplus.compiler.exprs.BooleanCompareExpression;
import com.yahoo.yqlplus.compiler.exprs.BytecodeArithmeticExpression;
import com.yahoo.yqlplus.compiler.exprs.BytecodeNegateExpression;
import com.yahoo.yqlplus.compiler.code.CodeEmitter;
import com.yahoo.yqlplus.compiler.exprs.CompareExpression;
import com.yahoo.yqlplus.compiler.exprs.EqualsExpression;
import com.yahoo.yqlplus.compiler.code.LocalCodeChunk;
import com.yahoo.yqlplus.compiler.code.LocalValue;
import com.yahoo.yqlplus.compiler.exprs.MulticompareExpression;
...
import com.yahoo.yqlplus.compiler.exprs.NullCheckedEvaluatedExpression;
...
public abstract class ExpressionHandler extends TypesHandler implements ScopedBuilder {
    ...
    @Override
    public BytecodeExpression scatter(Location location, BytecodeExpression runtime, BytecodeExpression iterable, CallableInvocable function) {
    ...
    @Override
    public BytecodeExpression fork(Location location, BytecodeExpression runtime, CallableInvocable function, List<BytecodeExpression> arguments) {
        TypeWidget resultType;
        boolean async = false;
        if (function.getResultType().isPromise()) {
            async = true;
