...
public enum SequenceOperator implements Operator {
    ...
    DISTINCT(SequenceOperator.class),
    EXTRACT(SequenceOperator.class, ExpressionOperator.class), // transform a sequence by mapping an expression over it (same rules as ProjectOperator.FIELD's expression
